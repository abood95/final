...
include('../contaction.php');
include('../system_constnt.php');

if(isset($_SESSION['log_in']) && $_SESSION['log_in'] == true){
   	
	if(isset($_SESSION['idadmin'])){
		// Query select from mysqli 
		$id = $_SESSION['idadmin'];
				...
				<div id="kt_aside" class="aside aside-extended bg-white" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<div class="aside-nav d-flex flex-column flex-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								<div class="menu-item py-2">
									<a class="menu-link active menu-center" href="./homepage.php" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									<span class="menu-link menu-center" title="Categories" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon me-0">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										<div class="menu-item">
											<div class="menu-content">
												<span class="menu-section fs-5 fw-bolder ps-1 py-1">Categeris</span>
											</div>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="./show_categories.php" data-kt-page="pro">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Show All Categeris
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="./add_categories.php">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">App Categeris</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="./show_categories.php" data-kt-page="pro">
												...
												<span class="menu-title">Edit Categeris
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="./show_categories.php" data-kt-page="pro">
												...
												<span class="menu-title">Delete Categeris
											</a>
										</div>
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									<span class="menu-link menu-center" title="Options Admins And Profile" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon me-0">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										<div class="menu-item">
											<div class="menu-content">
												<span class="menu-section fs-5 fw-bolder ps-1 py-1">Options</span>
											</div>
										</div>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="./add_admin.php" data-kt-page="pro">
													<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Add New Admin
														</span>
													</a>
												</div>
												<div class="menu-item">
													<a class="menu-link" href="./show_admin.php" data-kt-page="pro">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Edit Admin
													</a>
												</div>
												<div class="menu-item">
													<a class="menu-link" href="./show_admin.php" data-kt-page="pro">
														...
														<span class="menu-title">Show All Admin
													</a>
												</div>
											...
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="#" data-kt-page="pro">
														...
														<span class="menu-title">Show Profile
													</a>
												</div>
												<div class="menu-item">
													<a class="menu-link" href="#" data-kt-page="pro">
														...
														<span class="menu-title">Edit Your Profile
													</a>
												</div>
												<div class="menu-item">
													<a class="menu-link" href="#" data-kt-page="pro">
						...
						<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
							<!--begin::Menu-->
							<div class="mb-7">
								<button type="button" class="btn btm-sm btn-icon btn-color-gray-400 btn-active-color-primary btn-active-light" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-kt-menu-flip="top-end" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="Option Catgeries">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<div class="menu-content fs-6 text-dark fw-bolder px-3 py-4">Category options : </div>
									</div>
									<!--end::Menu item-->
									...
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<a href="./add_categories.php" class="menu-link px-3">Add Category </a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<a href="./show_categories.php" class="menu-link px-3">Show Category </a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start" data-kt-menu-flip="left-start, top">
										...
										<div class="menu-sub menu-sub-dropdown w-175px py-4">
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="./add_stores.php" class="menu-link px-3">Add Stores</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="./show_categories.php" class="menu-link px-3">Show Stores</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="./show_categories.php" class="menu-link px-3">Edit Stores</a>
											</div>
											<!--end::Menu item-->
										</div>
										<!--end::Menu sub-->
									...
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<a href="./show_categories.php" class="menu-link px-3">Edit categories</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu separator-->
									...
									<div class="menu-item px-3">
										<div class="menu-content px-3 py-3">
											<a class="btn btn-primary btn-sm px-4" href="../../public/homePage.php">GO To Public Web siet</a>
										</div>
									</div>
									<!--end::Menu item-->
								</div>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-1 fs-2">Welcome to <?= $row['name'] ?>
								...
								<li class="breadcrumb-item text-dark">Home</li>
									...
									<li class="breadcrumb-item text-muted">
										<a href="index.html" class="text-muted">Profile</a>
									</li>
								</ul>
								<!--end::Breadcrumb -->
							</div>
							...
							<div class="d-flex align-items-stretch flex-shrink-0">
								...
								<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
										<img src="<?= $system["Url_name"].$row['image'] ?>" alt="metronic" />
									</div>
									<!--begin::Menu-->
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													<img alt="Logo" src="<?= $system["Url_name"].$row['image'] ?>" />
												</div>
												<!--end::Avatar-->
												<!--begin::Username-->
												<div class="d-flex flex-column">
													<div class="fw-bolder d-flex align-items-center fs-5"><?= $row['name'] ?>
													<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"></span></div>
													<a href="#" class="fw-bold text-muted text-hover-primary fs-7"><?= $row['email'] ?></a>
												</div>
												<!--end::Username-->
											</div>
										</div>
										...
										<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-kt-menu-flip="bottom">
											<a href="#" class="menu-link px-5">
												...
												<img class="w-15px h-15px rounded-1 ms-2" src="<?= $system["Url_name"].$row['image'] ?>" alt="metronic" /></span></span>
											</a>
											<!--begin::Menu sub-->
											<div class="menu-sub menu-sub-dropdown w-175px py-4">
												<!--begin::Menu item-->
						...
						<div class="container" id="kt_content_container">
									...
									<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
										...
										<div class="me-7 mb-4">
											<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
												<img src="<?= $system["Url_name"].$row['image']?>" alt="image">
											...
											<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
												...
												<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center mb-2">
														<a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1"><?= $row['name'] ?></a>
														<a href="#">
											...
											<div class="d-flex flex-wrap flex-stack">
													...
													<div class="d-flex flex-wrap">
														...
														<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
															...
															<div class="d-flex align-items-center">
																...
																<!--end::Svg Icon-->
																<!-- Start Code PHP query  ------------------------------>
																<?php 
																
																?>
																<!-- End Code PHP query  ------------------------------>
																<div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="<?= $row_on ?>"><?= $row['numadd'] ?></div>
															</div>
															<!--end::Number-->
															<!--begin::Label-->
														...
														<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
															...
															<div class="d-flex align-items-center">
																...
																<!--end::Svg Icon-->
																<div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="80" data-kt-countup-prefix="%">%80</div>
															</div>
															<!--end::Number-->
												...
												<div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
													...
													<div class="h-5px mx-3 w-100 bg-light mb-3">
														<div class="bg-success rounded h-5px" role="progressbar" style="width: 60%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
													</div>
												</div>
												<!--end::Progress-->
											</div>
							...
							<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
								...
								<div class="card-header cursor-pointer">
									...
									<!--end::Card title-->
									<!--begin::Action-->
									<a href="http://localhost/final_project_lap/dashbord/php/edit_admin.php?id=<?=$row['id']?>" class="btn btn-primary align-self-center">Edit Profile</a>
									<!--end::Action-->
								</div>
								<!--begin::Card header-->
								<!--begin::Card body-->
								<div class="card-body p-9">
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="fw-bolder fs-6 text-dark"><?= $row['name'] ?></span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8 fv-row">
											<span class="fw-bold fs-6"><?= $row['email'] ?></span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8 d-flex align-items-center">
											<span class="fw-bolder fs-6 me-2"><?= $row['phone']?></span>
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="fw-bolder fs-6 text-dark"><?= $row['address'] ?></span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row flex-stack">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">ENG-Faisal</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
